      ...
      <div className="text-center relative z-10">
        <div className="gradient-border glow-blue-intense mb-8 animate-slide-in-down">
          <div className="gradient-border-inner p-8 relative overflow-hidden">
            ...
            <h3 className="text-3xl font-bold text-black dark:text-white mb-4 text-shimmer">
              Redirecting in {countdown}...
            </h3>

            <p className="text-gray-700 dark:text-gray-400 mb-6 transition-colors duration-300 hover:text-gray-900 dark:hover:text-gray-300">
        ...
        {/* Subtle hint text */}
        <p className="text-gray-600 dark:text-gray-500 text-xs mt-6 animate-pulse">
